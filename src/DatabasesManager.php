...
class DatabasesManager
{
    ...
    /**
     * Конструктор.
     * @param array[]|DatabaseInterface[] cоединения или конфиги соединений по именам
     * @throws \RuntimeException
     */
    ...
    /**
     * Хук перехвата получения соединения из di контейнера.
     * @param string|null имя соединения
     * @return self
     */
    public function __invoke(string $name = null)
    {
        return $name ? $this->get($name) : $this->last();
    }
}
